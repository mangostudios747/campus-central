...
<div >
  ...
  <v-sheet class='pt-5' elevation='0' color='transparent' rounded='lg'>
    <v-row><h1  class='px-4 pb-2'>Classes </h1><v-spacer></v-spacer><v-btn class='mr-7' style='padding: 0 0 !important;' rounded color='accent' ><v-icon >mdi-reload</v-icon></v-btn></v-row>
