<template>
  ...
  <v-row v-if="$store.getters['hc/currentEvent'].isValid" class='mt-10 px-4'>
    <v-col cols='4'>
      <v-card  elevation='3' color='rgba(256,256,256,0.24)' class='text-center py-7'>
    ...
    <v-col>
      <v-card v-if=" $store.getters['hc/currentEvent'].meta" class='py-3' color='rgba(256,256,256,0.24)'>
